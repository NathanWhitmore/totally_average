...
If you are interested in understanding the central limit theorem and the normal distribution I highly recommend the videos below from the [**Khan academy](https://www.khanacademy.org/) and [**3blue1brown's**](https://www.3blue1brown.com/). You can watch these by clicking on the thumbnail below:
